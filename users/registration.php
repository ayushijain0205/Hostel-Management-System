...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <input type="password" class="form-control" placeholder="Password" required="required" name="password"><br >
		             <input type="text"  pattern="\d{10}" class="form-control" maxlength="10" name="contactno" placeholder="Contact no" required="required" autofocus>
		            <br>
    ...
    <script>
        $.backstretch("https://divisare-res.cloudinary.com/images/c_limit,f_auto,h_2000,q_auto,w_3000/v1462375036/jpegkujudngmmbp0jri0/mccullough-mulvin-architects-thapar-university-expansion.jpg", {speed: 500});
    </script>
