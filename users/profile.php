...
<div class="form-group">
 ...
 <div class="col-sm-4">
 <input type="tel" name="contactno" maxlength="10" pattern="\d{10}" autocomplete="off" required="required" value="<?php echo htmlentities($row['contactNo']);?>" class="form-control">
 </div>
...
<div class="col-sm-4">
<input type="text" name="pincode" maxlength="9" required="required" value="<?php echo htmlentities($row['pincode']);?>" class="form-control">
</div>
...
<?php } ?>
                          ...
                          <div class="form-group">
                           <div class="col-sm-10" style="padding-left:45% ">
