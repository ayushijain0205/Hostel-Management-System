...
<html lang="en">
  <head>
    ...
    <title>HGS | User Register Complaint</title>
...
<label class="col-sm-2 col-sm-2 control-label" autocomplete="off">Nature of Complaint</label>
<div class="col-sm-4" autocomplete="off">
<input type="text" name="noc" required="required" value="" required="" class="form-control" autocomplete="off">
</div>

</div>

<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label" autocomplete="off">Complaint Details (max 2000 words) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000" autocomplete="off"></textarea>
</div>
</div>
<div class="form-group">
