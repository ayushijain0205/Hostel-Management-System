...
<html lang="en">
  <head>
    ...
    <title>HGS | Complaint Details</title>
...
<label class="col-sm-2 col-sm-2 control-label"><b>Hostel :</b></label>
              <div class="col-sm-4">
  ...
  <div class="row mt" autocomplete="off">
            <label class="col-sm-2 col-sm-2 control-label" autocomplete="off" ><b>Nature of Complaint :</b></label>
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label" autocomplete="off"><b>Complaint Details </label>
              <div class="col-sm-10">
