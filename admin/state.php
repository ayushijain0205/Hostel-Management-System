...
<label class="control-label" for="basicinput" autocomplete="off">Hostel Name</label>
<div class="controls">
<input type="text " autocomplete="off " placeholder="Enter Hostel Name"  name="Hostel" class="span8 tip" required>
</div>
</div>
